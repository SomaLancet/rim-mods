...
GENEPACK_REPROCESSOR_DLL="${GENEPACK_REPROCESSOR_DLL:-${HOME}/Library/Application Support/Steam/steamapps/workshop/content/294100/3277539761/1.6/Assemblies/GenepackReprocessor.dll}"
OUT="$ROOT/1.6/Assemblies/RWUGenepackReprocessorSettingsFix.dll"
...
csc -target:library -langversion:7.3 -nologo \
  ...
  -r:"$HARMONY_DLL" \
  -r:"$GENEPACK_REPROCESSOR_DLL" \
  "$ROOT/Source/RWUGenepackReprocessorSettingsFix/RWUGenepackReprocessorSettingsFix.cs"
