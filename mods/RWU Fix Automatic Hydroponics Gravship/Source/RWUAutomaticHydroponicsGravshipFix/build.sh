...
PIPE_SYSTEM="${PIPE_SYSTEM:-$HOME/Library/Application Support/Steam/steamapps/workshop/content/294100/2023507013/1.6/Assemblies/PipeSystem.dll}"
OUT="$ROOT/1.6/Assemblies/RWUAutomaticHydroponicsGravshipFix.dll"
...
csc -target:library -langversion:7.3 -nologo \
  ...
  -r:"$HARMONY" \
  -r:"$PIPE_SYSTEM" \
  "$ROOT/Source/RWUAutomaticHydroponicsGravshipFix/RWUAutomaticHydroponicsGravshipFix.cs"
